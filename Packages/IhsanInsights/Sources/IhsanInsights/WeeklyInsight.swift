...
@Generable(description: "A short, factual weekly summary of one user's materialized prayer statistics.")
public struct WeeklyInsight: Equatable, Sendable {
    @Guide(description: "One neutral factual sentence based only on the provided numeric weekly data. No advice, religious content, or quotation marks.")
