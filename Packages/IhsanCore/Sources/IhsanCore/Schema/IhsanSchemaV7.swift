...
/// Frozen snapshot of the schema as it stood at V7: V6 plus
/// `AdhkarSession` and the Adhkar group's preferences on
/// `UserSettings`.
///
/// Frozen rather than extended, for the same reason V5 and V6 were:
/// stores on disk already claim this version, and changing what it
/// means leaves them unmigratable ("unknown model version"). The live
