...
/// Frozen snapshot of the schema as it stood when the wider-worship
/// layer shipped: V3 plus `FastLog`, `DhikrSession`, and the defaulted
/// fasting-rhythm / dhikr-overlay preference fields on `UserSettings`.
/// These nested copies must never change — they exist so the migration
/// plan can describe a V4 store exactly. The live model classes are
